...
const Footer = () => {
  ...
  return (
    <footer className="bg-dark-100  px-6 sm:px-10 text-light-100">
      <div className="border-t-4 border-primary-500 w-[100px] mx-auto sm:mx-0"></div>
      <div className="flex flex-col items-center sm:items-start pt-12 gap-8">
        {/* logo */}
        <Image
      ...
      <div className="py-12 sm:py-8 sm:pb-10  grid grid-cols-1 sm:grid-cols-2 text-center sm:text-start text-light-100/50 body">
        <p className="sm:col-span-2 sm:pb-14">
          Audiophile is an all in one stop to fulfill your audio needs.
          We&apos;re a small team of music lovers and sound specialists who are
          devoted to helping you get the most out of personal audio. Come and
          visit our demo facility - we’re open 7 days a week.
        </p>
        <p className="font-bold py-8 sm:py-0">
          Copyright 2021. All Rights Reserved
        </p>
        <ul className="flex justify-center sm:justify-end gap-6 items-center">
